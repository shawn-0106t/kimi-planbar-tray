...
- **托盘常驻**——左键图标弹出悬浮窗（Windows 原生滑出动画），失焦自动隐藏；右键菜单：Open / Refresh / Settings / Exit
...
| 版本 | 体积 | 前提 | 内存占用（实测） |
|---|---|---|---|
| `KimiPlanbarTray-wpf.exe` | ~260 KB | 已安装 [.NET 8 桌面运行时](https://dotnet.microsoft.com/download/dotnet/8.0) | ~69 MB |
...
- **左键托盘图标**——显示 / 隐藏悬浮窗
- **右键托盘图标**——菜单：Open / Refresh / Settings / Exit
